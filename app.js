...
.narrative-box {
  ...
  display: flex;
  flex-direction: column;
  background: linear-gradient(145deg, rgba(20, 20, 25, 0.8), rgba(10, 10, 15, 0.6));
  border: 1px solid rgba(255, 255, 255, 0.05);
  border-radius: 16px;
  padding: 20px;
  margin-bottom: 28px;
...
.narrative-avatar {
  ...
  justify-content: center;
  font-size: 20px;
  box-shadow: 0 0 15px calc(var(--n-color) * 0.3);
...
.tactical-card {
  ...
  align-items: center;
  justify-content: center;
  /* Complex shadows: deep outer drop shadow, strong faint gold glow, inner depth */
  box-shadow: 
    0 4px 10px rgba(0, 0, 0, 0.8),
    0 0 15px rgba(212, 175, 55, 0.15),
    inset 0 0 15px rgba(212, 175, 55, 0.15); /* inner gold ambient light */
...
.tactical-shine {
  ...
  background: linear-gradient(
    -45deg,
    transparent 40%,
    rgba(212, 175, 55, 0.25) 50%, /* Gold shimmer instead of white */
    transparent 60%
  );
  background-size: 200% 200%;
  z-index: 3;
  animation: tacticalShimmer 5s infinite;
}

@keyframes tacticalShimmer {
...
.tactical-card:hover {
  border-color: rgba(255, 215, 0, 1); /* Brighter gold on hover */
  transform: translateY(-5px);
  box-shadow: 
    0 8px 24px rgba(0, 0, 0, 0.8),
    0 0 25px rgba(255, 215, 0, 0.3), /* intense outer glow */
